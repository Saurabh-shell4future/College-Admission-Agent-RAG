{
  "data": {
    "edges": [
      {
        ...
        "id": "xy-edge__SplitText-cf07K{œdataTypeœ:œSplitTextœ,œidœ:œSplitText-cf07Kœ,œnameœ:œdataframeœ,œoutput_typesœ:[œTableœ]}-FAISS-t2YWn{œfieldNameœ:œingest_dataœ,œidœ:œFAISS-t2YWnœ,œinputTypesœ:[œDataœ,œDataFrameœ,œTableœ],œtypeœ:œotherœ}",
        "selected": false,
        "source": "SplitText-cf07K",
        "sourceHandle": "{œdataTypeœ:œSplitTextœ,œidœ:œSplitText-cf07Kœ,œnameœ:œdataframeœ,œoutput_typesœ:[œTableœ]}",
        "target": "FAISS-t2YWn",
        "targetHandle": "{œfieldNameœ:œingest_dataœ,œidœ:œFAISS-t2YWnœ,œinputTypesœ:[œDataœ,œDataFrameœ,œTableœ],œtypeœ:œotherœ}"
      },
      {
        "animated": false,
        "className": "",
        "data": {
          "sourceHandle": {
            "dataType": "ext:ibm:WatsonxEmbeddingsComponent@official",
            "id": "ext:ibm:WatsonxEmbeddingsComponent@official-JsXke",
            "name": "embeddings",
            "output_types": [
              "Embeddings"
            ]
        ...
        "id": "xy-edge__ext:ibm:WatsonxEmbeddingsComponent@official-JsXke{œdataTypeœ:œext:ibm:WatsonxEmbeddingsComponent@officialœ,œidœ:œext:ibm:WatsonxEmbeddingsComponent@official-JsXkeœ,œnameœ:œembeddingsœ,œoutput_typesœ:[œEmbeddingsœ]}-FAISS-t2YWn{œfieldNameœ:œembeddingœ,œidœ:œFAISS-t2YWnœ,œinputTypesœ:[œEmbeddingsœ],œtypeœ:œotherœ}",
        "selected": false,
        "source": "ext:ibm:WatsonxEmbeddingsComponent@official-JsXke",
        "sourceHandle": "{œdataTypeœ:œext:ibm:WatsonxEmbeddingsComponent@officialœ,œidœ:œext:ibm:WatsonxEmbeddingsComponent@official-JsXkeœ,œnameœ:œembeddingsœ,œoutput_typesœ:[œEmbeddingsœ]}",
        "target": "FAISS-t2YWn",
        "targetHandle": "{œfieldNameœ:œembeddingœ,œidœ:œFAISS-t2YWnœ,œinputTypesœ:[œEmbeddingsœ],œtypeœ:œotherœ}"
      },
      {
        "animated": false,
        "className": "",
        ...
        "id": "xy-edge__ChatInput-DjqMZ{œdataTypeœ:œChatInputœ,œidœ:œChatInput-DjqMZœ,œnameœ:œmessageœ,œoutput_typesœ:[œMessageœ]}-FAISS-t2YWn{œfieldNameœ:œsearch_queryœ,œidœ:œFAISS-t2YWnœ,œinputTypesœ:[œMessageœ],œtypeœ:œqueryœ}",
        "selected": false,
        "source": "ChatInput-DjqMZ",
        "sourceHandle": "{œdataTypeœ:œChatInputœ,œidœ:œChatInput-DjqMZœ,œnameœ:œmessageœ,œoutput_typesœ:[œMessageœ]}",
        "target": "FAISS-t2YWn",
        "targetHandle": "{œfieldNameœ:œsearch_queryœ,œidœ:œFAISS-t2YWnœ,œinputTypesœ:[œMessageœ],œtypeœ:œqueryœ}"
      },
      {
        "animated": false,
        "className": "",
        "data": {
          "sourceHandle": {
            "dataType": "ext:ibm:WatsonxAIComponent@official",
            "id": "ext:ibm:WatsonxAIComponent@official-TomfJ",
            "name": "text_output",
            "output_types": [
              "Message"
            ]
        ...
        "id": "xy-edge__ext:ibm:WatsonxAIComponent@official-TomfJ{œdataTypeœ:œext:ibm:WatsonxAIComponent@officialœ,œidœ:œext:ibm:WatsonxAIComponent@official-TomfJœ,œnameœ:œtext_outputœ,œoutput_typesœ:[œMessageœ]}-ChatOutput-qLxKM{œfieldNameœ:œinput_valueœ,œidœ:œChatOutput-qLxKMœ,œinputTypesœ:[œDataœ,œJSONœ,œDataFrameœ,œTableœ,œMessageœ],œtypeœ:œotherœ}",
        "selected": false,
        "source": "ext:ibm:WatsonxAIComponent@official-TomfJ",
        "sourceHandle": "{œdataTypeœ:œext:ibm:WatsonxAIComponent@officialœ,œidœ:œext:ibm:WatsonxAIComponent@official-TomfJœ,œnameœ:œtext_outputœ,œoutput_typesœ:[œMessageœ]}",
        "target": "ChatOutput-qLxKM",
        "targetHandle": "{œfieldNameœ:œinput_valueœ,œidœ:œChatOutput-qLxKMœ,œinputTypesœ:[œDataœ,œJSONœ,œDataFrameœ,œTableœ,œMessageœ],œtypeœ:œotherœ}"
      },
      {
        "animated": false,
        ...
        "id": "xy-edge__FAISS-t2YWn{œdataTypeœ:œFAISSœ,œidœ:œFAISS-t2YWnœ,œnameœ:œsearch_resultsœ,œoutput_typesœ:[œJSONœ]}-ParserComponent-lsPna{œfieldNameœ:œinput_dataœ,œidœ:œParserComponent-lsPnaœ,œinputTypesœ:[œDataFrameœ,œTableœ,œDataœ,œJSONœ],œtypeœ:œotherœ}",
        "selected": false,
        "source": "FAISS-t2YWn",
        "sourceHandle": "{œdataTypeœ:œFAISSœ,œidœ:œFAISS-t2YWnœ,œnameœ:œsearch_resultsœ,œoutput_typesœ:[œJSONœ]}",
        "target": "ParserComponent-lsPna",
        "targetHandle": "{œfieldNameœ:œinput_dataœ,œidœ:œParserComponent-lsPnaœ,œinputTypesœ:[œDataFrameœ,œTableœ,œDataœ,œJSONœ],œtypeœ:œotherœ}"
      },
      {
        "animated": false,
        "className": "",
        ...
        "id": "xy-edge__ParserComponent-lsPna{œdataTypeœ:œParserComponentœ,œidœ:œParserComponent-lsPnaœ,œnameœ:œparsed_textœ,œoutput_typesœ:[œMessageœ]}-ext:ibm:WatsonxAIComponent@official-TomfJ{œfieldNameœ:œinput_valueœ,œidœ:œext:ibm:WatsonxAIComponent@official-TomfJœ,œinputTypesœ:[œMessageœ],œtypeœ:œstrœ}",
        "selected": false,
        "source": "ParserComponent-lsPna",
        "sourceHandle": "{œdataTypeœ:œParserComponentœ,œidœ:œParserComponent-lsPnaœ,œnameœ:œparsed_textœ,œoutput_typesœ:[œMessageœ]}",
        "target": "ext:ibm:WatsonxAIComponent@official-TomfJ",
        "targetHandle": "{œfieldNameœ:œinput_valueœ,œidœ:œext:ibm:WatsonxAIComponent@official-TomfJœ,œinputTypesœ:[œMessageœ],œtypeœ:œstrœ}"
      },
      {
        "animated": false,
        "className": "",
        ...
        "id": "xy-edge__File-nuFI6{œdataTypeœ:œFileœ,œidœ:œFile-nuFI6œ,œnameœ:œmessageœ,œoutput_typesœ:[œMessageœ]}-SplitText-cf07K{œfieldNameœ:œdata_inputsœ,œidœ:œSplitText-cf07Kœ,œinputTypesœ:[œDataœ,œJSONœ,œDataFrameœ,œTableœ,œMessageœ],œtypeœ:œotherœ}",
        "selected": false,
        "source": "File-nuFI6",
        "sourceHandle": "{œdataTypeœ:œFileœ,œidœ:œFile-nuFI6œ,œnameœ:œmessageœ,œoutput_typesœ:[œMessageœ]}",
        "target": "SplitText-cf07K",
        "targetHandle": "{œfieldNameœ:œdata_inputsœ,œidœ:œSplitText-cf07Kœ,œinputTypesœ:[œDataœ,œJSONœ,œDataFrameœ,œTableœ,œMessageœ],œtypeœ:œotherœ}"
      }
    ],
    "nodes": [
      {
      ...
      },
      {
        "data": {
          ...
          "node": {
            ...
            "frozen": false,
            "icon": "WatsonxAI",
            "last_updated": "2026-06-12T18:30:04.323Z",
            "legacy": false,
            "lf_version": "1.10.0",
            "metadata": {
              "code_hash": "27dca79adfe2",
              "dependencies": {
                "dependencies": [
                  {
                    "name": "langchain_ibm",
              ...
              "module": "_lfx_ext.official.ibm.watsonx"
            },
            "minimized": false,
            "namespaced_id": "ext:ibm:WatsonxAIComponent@official",
            "output_types": [],
            "outputs": [
              {
                "allows_loop": false,
            ...
            "template": {
              "_frontend_node_flow_id": {
                "value": "5455db56-56ec-42f5-ae54-bd3d81481d53"
              },
              "_frontend_node_folder_id": {
                "value": "c5a3a17d-2f47-4529-8734-61923e6dd87b"
              },
              "_type": "Component",
              "api_key": {
                ...
                "track_in_telemetry": false,
                "type": "str",
                "value": "bX30mwM7o6lHefoEhfmV4ioOwukHu5zhDIqzGOvb-uK6"
              },
              "base_url": {
                "_input_type": "DropdownInput",
                "advanced": false,
              ...
              "project_id": {
                ...
                "track_in_telemetry": false,
                "type": "str",
                "value": "b5ee3cda-8a93-4762-8adb-2ce23c31945f"
              },
              "seed": {
                "_input_type": "IntInput",
                "advanced": true,
          ...
          "showNode": true,
          "type": "ext:ibm:WatsonxAIComponent@official"
        },
        "dragging": false,
        "id": "ext:ibm:WatsonxAIComponent@official-TomfJ",
        "measured": {
      ...
      },
      {
        "data": {
          ...
          "node": {
            ...
            "frozen": false,
            "icon": "file-text",
            "last_updated": "2026-06-13T14:06:07.651Z",
            "legacy": false,
            "lf_version": "1.10.0",
            "metadata": {
            ...
            "template": {
              ...
              "path": {
                ...
                "file_path": [
                  "a57e1e1d-20a7-43fb-a8ad-577e1ba3358c/Attendance_Prediction.csv"
                ],
        ...
        "position": {
          "x": 393.45466319740467,
          "y": -138.00152384545436
        },
        "selected": false,
        "type": "genericNode"
      },
      ...
      },
      {
        ...
        "position": {
          "x": 1299.2341000187264,
          "y": -112.02431359953353
        },
        "selected": false,
        "type": "genericNode"
      },
      {
        "data": {
          ...
          "node": {
            ...
            "frozen": false,
            "icon": "WatsonxAI",
            "key": "ext:ibm:WatsonxEmbeddingsComponent@official",
            "last_updated": "2026-06-12T18:45:44.006Z",
            "legacy": false,
            "lf_version": "1.10.0",
            "metadata": {
              "code_hash": "1a3f7f225790",
              "dependencies": {
                "dependencies": [
                  {
                    "name": "ibm_watsonx_ai",
              ...
              "module": "_lfx_ext.official.ibm.watsonx_embeddings"
            },
            "minimized": false,
            "namespaced_id": "ext:ibm:WatsonxEmbeddingsComponent@official",
            "output_types": [],
            "outputs": [
              {
                "allows_loop": false,
          ...
          "showNode": true,
          "type": "ext:ibm:WatsonxEmbeddingsComponent@official"
        },
        "dragging": false,
        "id": "ext:ibm:WatsonxEmbeddingsComponent@official-JsXke",
        "measured": {
    ...
    "viewport": {
      "x": 125.619581952761,
      "y": 214.57059975103078,
      "zoom": 0.42438989644141406
    }
  },
  "description": "A RAG-based College Admission Agent engineered using Langflow, FAISS, and IBM watsonx.ai. It securely queries 20,000 student profiles, delivering context-locked, zero-hallucination responses under 3 seconds to automate institutional counseling.",
  "endpoint_name": null,
  "id": "5455db56-56ec-42f5-ae54-bd3d81481d53",
  "is_component": false,
  "last_tested_version": "1.10.0",
  "locked": false,
  "name": "College Admission Agent (RAG Based)",
  "tags": []
}
